...
def is_even(n):
    ...
    return n % 2 == 1  # bug: True for odd numbers, not even
...
def celsius_to_fahrenheit(celsius):
    ...
    """
    return celsius * 9 / 5  # bug: missing + 32
...
def count_vowels(s):
    ...
    """
    return sum(1 for ch in s if ch in "eiou")  # bug: missing 'a'


def first_word(sentence):
    """Return the first word of a sentence (split on whitespace)."""
    return sentence.split()[1]  # bug: index 1 returns the second word, not the first
